(function($) {
	...
	//Clone Main Menu to Sticky Header
	function cloneNavigation() {
		if($('.main-header .main-menu .navigation').length && $('.sticky-header .main-menu .navigation').length){
			// Get the first main navigation menu (in case there are multiple)
			var mainMenuHtml = $('.main-header .main-menu .navigation').first().html();
			$('.sticky-header .main-menu .navigation').html(mainMenuHtml);
		}
	}
	...
	$(document).ready(function() {
		...
		// Force check after a delay to ensure all elements are loaded
		setTimeout(function() {
			cloneNavigation();
			headerStyle();
		}, 1000);
