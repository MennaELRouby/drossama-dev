<x-dashboard.layout :title="__('dashboard.edit') . $admin->name">
    ...
    <!-- Page Header -->
    <x-dashboard.partials.page-header :header="__('dashboard.edit').$admin->name"
        :label_url="route('dashboard.admins.index')" :label="__('dashboard.admins')" />
    <!-- End Page Header -->
            ...
            <div class="card custom-card overflow-hidden">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('dashboard.admins.update',[$admin->id]) }}" method="POST"
                        ...
                        @csrf
                        @method('PATCH')
                        <!-- Hidden field to ensure permissions array is always sent -->
