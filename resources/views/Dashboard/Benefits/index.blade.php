        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">{{ __('dashboard.benefits') }}</h4>

                    <div class="page-title-right d-flex align-items-center">
                        <div class="btn btn-list">
                            <a href="{{ route('dashboard.benefits.create') }}" class="btn ripple btn-primary">
                        ...
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">{{ __('dashboard.benefits') }}</li>
                        </ol>
                    </div>
                </div>
            </div>
                            ...
                            <tbody>
                                @foreach ($Benefits as $Benefit)
                                    <tr id="{{ $Benefit->id }}">
                                        ...
                                        <td><a
                                                href="{{ route('dashboard.benefits.edit', $Benefit->id) }}">{{ $Benefit->id }}</a>
                                        </td>
                                        <td><a
                                                href="{{ route('dashboard.benefits.edit', $Benefit->id) }}">{{ $Benefit->title_en }}</a>
                                        </td>
                                        <td><a
                                                href="{{ route('dashboard.benefits.edit', $Benefit->id) }}">{{ $Benefit->title_ar }}</a>
                                        </td>
                                        <td>
                                            @if ($Benefit->image_path && file_exists(public_path($Benefit->image_path)))
                                                <a href="{{ route('dashboard.benefits.edit', $Benefit->id) }}">
                                                    <img src="{{ asset($Benefit->image_path) }}" width="70"
                                        ...
                                        <td>
                                            <div class="action-buttons">
                                                ...
                                                <form action="{{ route('dashboard.benefits.destroy', $Benefit->id) }}"
