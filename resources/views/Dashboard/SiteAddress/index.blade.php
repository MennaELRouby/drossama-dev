        <x-dashboard.layout :title="__('dashboard.site_addresses')">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">{{ __('dashboard.site_addresses') }}</h4>

                            <div class="page-title-right d-flex align-items-center">
                                <div class="btn btn-list">
                                    <a href="{{ route('dashboard.site-addresses.create') }}"
                                ...
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">{{ __('dashboard.site_addresses') }}</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="dashboard-table-container">
                            <div class="card-header">
                                <h4>{{ __('dashboard.site_addresses') }}</h4>
                            </div>
                            <div class="card-body">
                                                ...
                                                <td class="text-center">
                                                    <div class="checkbox-enhanced">
                                                        <input type="checkbox" name="checkbox"
                                                            class="check-inputs form-check-input"
                                                            value="{{ $site_address->id }}">
                                                        <span class="checkmark"></span>
                                                    </div>
                                                </td>
                                                <td><a
                                                        href="{{ route('dashboard.site-addresses.edit', $site_address->id) }}">{{ $site_address->title }}</a>
                                                </td>
                                                <td><a
                                                        href="{{ route('dashboard.site-addresses.edit', $site_address->id) }}">{{ $site_address->address }}</a>
                                                </td>
                                                <td><a
                                                        href="{{ route('dashboard.site-addresses.edit', $site_address->id) }}">{{ $site_address->order }}</a>
                                                </td>
                                                <td>
                                                    @if ($site_address->status == 1)
                                                        <span
                                                            class="status-badge active">{{ __('dashboard.yes') }}</span>
                                                    @else
                                                        <span
                                                            class="status-badge inactive">{{ __('dashboard.no') }}</span>
                                                    @endif
                                                </td>
                                                <td>
                                                    <div class="action-buttons">
                                                        <a href="{{ route('dashboard.site-addresses.edit', $site_address->id) }}"
                                                            class="btn-action edit" title="{{ __('dashboard.edit') }}">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                        <form
                                                            action="{{ route('dashboard.site-addresses.destroy', $site_address->id) }}"
