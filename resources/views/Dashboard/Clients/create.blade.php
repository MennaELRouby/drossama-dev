<x-dashboard.layout :title="__('dashboard.add_client')">

    <!-- Page Header -->
    <x-dashboard.partials.page-header :header="__('dashboard.add_client')" :label_url="route('dashboard.clients.index')" :label="__('dashboard.clients')" />
    <!-- End Page Header -->
        ...
        <div class="col-sm-12 col-xl-12 col-lg-12">
            <div class="card custom-card overflow-hidden">
                <div class="card-header">
                    <h4 class="card-title">{{ __('dashboard.add_client') }}</h4>
                </div>
