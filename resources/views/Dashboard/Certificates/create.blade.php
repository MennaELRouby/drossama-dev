<x-dashboard.layout :title="__('dashboard.add_certificate')">

    <!-- Page Header -->
    <x-dashboard.partials.page-header :header="__('dashboard.add_certificate')" :label_url="route('dashboard.certificates.index')" :label="__('dashboard.certificates')" />
    <!-- End Page Header -->
        ...
        <div class="col-sm-12 col-xl-12 col-lg-12">
            <div class="card custom-card overflow-hidden">
                <div class="card-header">
                    <h4 class="card-title">{{ __('dashboard.add_certificate') }}</h4>
                </div>
