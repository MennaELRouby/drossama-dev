                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-2">
                                ...
                                @if ($project->image_path)
                                    <img src="{{ $project->image_path }}" width="150" class="img-thumbnail">
                                @else
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input class="form-control" name="alt_image" type="text"
                                    ...
                                    value="{{ old('alt_image', $project->alt_image) }}">
                            </div>
                            ...
                            <div class="form-group col-md-2">
                                ...
                                @if ($project->icon_path)
                                    <img src="{{ $project->icon_path }}" width="150" class="img-thumbnail">
                                @else
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input class="form-control" name="alt_icon" type="text"
                                    ...
                                    value="{{ old('alt_icon', $project->alt_icon) }}">
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                <label for="project_images">{{ trans('dashboard.project_images') }}</label>
                            ...
                            @if (!empty($project->images) && $project->images->count() > 0)
                                <div class="col-12">
                                    ...
                                    <div class="d-flex flex-wrap mb-3 align-items-center">
                                        ...
                                        <button type="button" id="delete_all_images" data-id="{{ $project->id }}"
                                            class="btn btn-danger me-2 mb-2">
                                ...
                                <div class="form-group col-md-3">
                                    <div class="d-flex flex-wrap gap-2">
                                        ...
                                        <input type="checkbox" id="switch1" switch="none" value="1"
                                            name="status" {{ old('status', $project->status) ? 'checked' : '' }} />
                                ...
                                <div class="form-group col-md-3">
                                    <div class="d-flex flex-wrap gap-2">
                                        ...
                                        <input type="checkbox" id="switch2" switch="none" value="1"
                                            name="show_in_home"
                                            {{ old('show_in_home', $project->show_in_home) ? 'checked' : '' }} />
                                ...
                                <div class="form-group col-md-3">
                                    <div class="d-flex flex-wrap gap-2">
                                        ...
                                        <input type="checkbox" id="switch3" switch="none" value="1"
                                            name="show_in_header"
                                            {{ old('show_in_header', $project->show_in_header) ? 'checked' : '' }} />
                                ...
                                <div class="form-group col-md-3">
                                    <div class="d-flex flex-wrap gap-2">
                                        ...
                                        <input type="checkbox" id="switch4" switch="none" value="1"
                                            name="show_in_footer"
                                            {{ old('show_in_footer', $project->show_in_footer) ? 'checked' : '' }} />
                            ...
                            <div class="col-12">
                                ...
                                <div class="row">
                                    ...
                                    <x-dashboard.multilingual-input name="meta_title" type="textarea"
                                        :required="false" :rows="2" :model="$project" />
                                    ...
                                    <div class="form-group col-md-12">
                                        <div class="d-flex flex-wrap gap-2">
                                            ...
                                            <input type="checkbox" id="switch5" switch="none" value="1"
                                                name="index" {{ old('index', $project->index) ? 'checked' : '' }} />
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <a href="{{ route('dashboard.projects.index') }}" class="btn btn-danger ms-2">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (deleteSelectedBtn) {
                deleteSelectedBtn.addEventListener('click', function(e) {
                    ...
                    fetch('{{ route('dashboard.projects.deleteSelectedImages') }}', {
                            method: 'POST',
                            headers: {
            ...
            if (deleteAllBtn) {
                deleteAllBtn.addEventListener('click', function(e) {
                    ...
                    fetch('{{ route('dashboard.projects.deleteAllImages') }}', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
                                'X-CSRF-TOKEN': '{{ csrf_token() }}'
            ...
            if (saveOrderBtn) {
                saveOrderBtn.addEventListener('click', function(e) {
                    ...
                    fetch('{{ route('dashboard.projects.reorderImages') }}', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
                                'X-CSRF-TOKEN': '{{ csrf_token() }}'
            ...
            document.querySelectorAll('.delete_img_btn').forEach(function(btn) {
                btn.addEventListener('click', function(e) {
                    ...
                    fetch('{{ route('dashboard.projects.deleteImage') }}', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
                                'X-CSRF-TOKEN': '{{ csrf_token() }}'
