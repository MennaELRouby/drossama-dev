                  ...
                  <div class="row">
                     <div class="col-xl-6 col-lg-10">
                        <div class="tp-service-left p-relative">
                           <div class="tp-service-title-box mb-40">
                              <span class="tp-section-respect1 mb-10">Our Catalogue</span>
                              <h4 class="tp-section-title tp_reveal_anim">Discover All Modern Aluminum Systems.</h4>
                           </div>
                           <div class="tp-service-btn-box d-flex align-items-center justify-content-between gap-20">
                              <div class="tp-blog-4-btn">
                                 <a class="tp-btn-circle tp-hover-btn-wrapper  tp-hover-btn" href="catalogue.html">
                                    <span class="tp-btn-circle-text">Read More</span>
                     ...
                     <div class="col-xl-6">
                        <div class="tp-service-right">
                           <img src="assets/img/Brochoure-BF.png" alt="">
                        </div>
                     </div>
                  </div>
               </div>
